...
**Goal:** Provide a simple command-line interface to listing out, playing songs from, and utilizing controls for Music.app.  I decided against using a library such as ncurses to build out a full TUI application, as I think it is preferable to interface via quick commands a light "widget".
